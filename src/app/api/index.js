...
machines.read = (id) =>
  new Promise((resolve, reject) => {
    authrequest.get('/api/machines/' + id).end((err, res) => {
      if (err) {
        reject(res);
      } else {
        resolve(res);
...
machines.delete = (id) =>
  new Promise((resolve, reject) => {
    authrequest.delete('/api/machines/' + id).end((err, res) => {
      if (err) {
        reject(res);
      } else {
        resolve(res);
...
machines.run = (id) =>
  new Promise((resolve, reject) => {
    authrequest.post('/api/machines/run/' + id).end((err, res) => {
      if (err) {
        reject(res);
      } else {
        resolve(res);
...
file.upload = (file, port, visualizer) =>
  new Promise((resolve, reject) => {
    authrequest
      .post('/api/file')
      .attach('gcode', file)
