      ...
      <div className={styles.container}>
        ...
        <div className={styles.buttonContainer}>
          ...
          <button
            ...
            tabIndex={0}
            className={
              activeButton === 'Right' ? `${styles.faceRightActive}` : `${styles.faceRight}`
            }
            onClick={(event) => {
          ...
          <button
            ...
            tabIndex={0}
            className={
              activeButton === 'Front' ? `${styles.faceFrontActive}` : `${styles.faceFront}`
            }
            onClick={(event) => {
              camera.toFrontView();
              this.handleClick(event);
          ...
          />
          <button type="button" tabIndex={0} className={styles.cornerC1} />
          <button type="button" tabIndex={0} className={styles.cornerC2} />
          <button
            title={i18n._('Left')}
            type="button"
            tabIndex={0}
          ...
          <button type="button" tabIndex={0} className={styles.cornerC3} />
        </div>
      </div>
    );
  };
