    ...
    return (
      <div className={styles.Sidebar}>
        ...
        {state.modal.name === MODAL_PREFERENCES && (
          <Preferences state={state} modalClose={actions.closeModal} />
        )}
        {state.modal.name === MODAL_SURFACING && (
          <Surfacing state={state} modalClose={actions.closeModal} />
        )}
        {state.modal.name === MODAL_CALIBRATE && (
          <Calibration state={state} modalClose={actions.closeModal} />
        )}
