    ...
    <Fieldset legend="Visualizer Options">
      <div className={styles.addMargin}>
        <div className={classNames(styles.vizGrid)}>
          ...
          <ToggleSwitch
            checked={!disabled}
            onChange={() => visualizerActions.handleVisEnabledToggle()}
            size="sm"
          />
          <ToggleSwitch
            checked={!disabledLite}
            onChange={() => visualizerActions.handleVisEnabledToggle(true)}
            size="lg"
          />
          ...
          <ToggleSwitch
            ...
            onChange={() => visualizerActions.handleAnimationToggle()}
            size="md"
          />
          <ToggleSwitch
            checked={objects.cuttingToolAnimation.visibleLite}
            onChange={() => visualizerActions.handleAnimationToggle(true)}
            size="md"
          />
          ...
          <ToggleSwitch
            ...
            onChange={() => visualizerActions.handleBitToggle(true)}
            size="md"
          />
          <Tooltip
          ...
          <ToggleSwitch
            ...
            onChange={() => visualizerActions.handleCutPathToggle()}
            size="md"
          />
          <ToggleSwitch
            checked={objects.cutPath.visibleLite}
            onChange={() => visualizerActions.handleCutPathToggle(true)}
            size="md"
          />
        </div>
        <small>
          Specify which visualizer features are enabled or disable in both regular mode and
          light-mode, in order to save computer resources
        </small>
      </div>
      {/*
