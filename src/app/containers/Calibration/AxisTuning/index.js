      ...
      >
        ...
        {!introComplete && (
          <p style={{ width: '100%', fontWeight: 'bold' }}>
            Whichever axis you’ll be tuning, please place it in an initial location so that it’ll
            have space to move to the right (for X), backwards (for Y), and downwards (for Z).
          </p>
        )}
        {introComplete && (
          <p style={{ width: '100%', fontWeight: 'bold' }}>
