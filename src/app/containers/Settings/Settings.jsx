...
class Settings extends PureComponent {
  ...
  actions = {
    ...
    machineProfiles: {
      fetchRecords: (options) => {
        ...
        const { page = state.pagination.page, pageLength = state.pagination.pageLength } = {
          ...options
        };
            ...
            try {
              ...
              api.machines
                ...
                .then((machineProfiles) => {
                  ...
                  const matchedMachineProfile = _find(machineProfiles, {
                    id: currentMachineProfileId
                  });
  ...
  render() {
    ...
    const sectionItems = this.sections.map((section, index) => (
      <li
        key={section.id}
        className={classNames({ [styles.active]: activeSection.id === section.id })}
      >
