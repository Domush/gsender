...
class FirmwareSettings extends PureComponent {
  ...
  render() {
    if (this.state.settings.settings !== undefined) {
      ...
      return (
        <div
          className={classNames(styles.hidden, styles.settingsContainer, {
            [styles.visible]: this.props.active
          })}
        >
          <header className={styles.header}>
            <h3 className={styles.firmware}>Firmware Settings</h3>
            <div className={styles.firmwareSettingsButtons}>
              <button
                onClick={this.applyNewSettings}
                type="button"
                className={
                  this.state.disable ? `${styles.wizardButtonsDisabled}` : `${styles.wizardButtons}`
                }
              >
                Apply New Settings
              </button>
              <button onClick={this.restoreSettings} type="button" className={styles.wizardButtons}>
