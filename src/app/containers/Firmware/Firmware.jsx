...
class Firmware extends PureComponent {
  ...
  controllerEvents = {
    message: () => {
      ...
      this.setState({
        finishedMessage: `Flashing completed successfully on port: ${this.state.port}! Please reconnect your machine`
      });
        ...
        <div className={styles.toolModal}>
          ...
          <div className={styles.firmwareContainer}>
            <div className={styles.settingsContainer}>
              {!haveSettings && (
                <NotConnectedWarning handleConnect={() => this.actions.connectToLastDevice()} />
              )}
              {haveSettings &&
            ...
            <div className={styles.buttonsContainer}>
              <div className={styles.buttonsTop}>
                {this.state.initiateFlashing ? (
                  ...
                  >
                    This feature exists to flash the GRBL firmware onto compatible Arduino boards
                    only! Improper flashing could damage your device on port: {this.state.port}.
                  </ToolsNotificationModal>
                ) : (
                  ''
                )}
                <TooltipCustom
                  content="Flash your Arduino board to GRBL default values"
                  location="default"
                >
                  <ToolModalButton
                    icon="fas fa-bolt"
              ...
              <div className={styles.buttonsMiddle}>
                <TooltipCustom
                  content="Import your settings file you saved previously"
                  location="default"
                >
                  <ToolModalButton
                    onClick={this.upload}
              ...
              <TooltipCustom
                ...
                location="default"
                disabled={this.state.newSettingsButtonDisabled}
              >
                <ToolModalButton
                  icon="fas fa-tasks"
